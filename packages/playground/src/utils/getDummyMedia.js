...
function getDummyMedia() {
  return [
    createDummyImageData({
      mimeType: 'image/png',
      src: 'https://i.imgur.com/0bGv8CM.jpg',
      width: 1536,
      height: 768,
      id: 1,
    ...
    createDummyImageData({
      mimeType: 'image/png',
      src: 'https://i.imgur.com/iAdeBqF.jpg',
      width: 1536,
      height: 768,
      id: 1,
      title: 'Fresh and Bright 1',
    ...
    createDummyImageData({
      mimeType: 'image/png',
      src: 'https://i.imgur.com/ZpZtE4v.jpg',
      width: 1536,
      height: 768,
      id: 1,
      title: 'Fresh and Bright 1',
    ...
    createDummyImageData({
      mimeType: 'image/png',
      src: 'https://i.imgur.com/g4PmVne.png',
      width: 1024,
      height: 512,
      id: 1,
      title: 'Fresh and Bright 1',
    ...
    createDummyImageData({
      mimeType: 'image/png',
      src: 'https://i.imgur.com/Z1ftSDU.jpg',
      width: 768,
      height: 768,
      id: 1,
      title: 'Fresh and Bright 1',
